...
class ProjectRequest(BaseModel):
    environment: float = Field(7.6, ge=-20, le=20)
...
def districts_baseline():
    """Baseline projection at D+7.6, all sliders at 0."""
    return project(BUNDLE, environment=7.6)
...
def senate_baseline():
    return senate.project(SENATE_BUNDLE, environment=7.6)
