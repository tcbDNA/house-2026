...
class ProjectRequest(BaseModel):
    environment: float = Field(6.2, ge=-20, le=20)
...
def districts_baseline():
    """Baseline projection at D+6.2, all sliders at 0."""
    return project(BUNDLE, environment=6.2)
...
def senate_baseline():
    return senate.project(SENATE_BUNDLE, environment=6.2)
