...
class ProjectRequest(BaseModel):
    environment: float = Field(6.7, ge=-20, le=20)
...
def districts_baseline():
    """Baseline projection at D+6.7, all sliders at 0."""
    return project(BUNDLE, environment=6.7)
...
def senate_baseline():
    return senate.project(SENATE_BUNDLE, environment=6.7)
